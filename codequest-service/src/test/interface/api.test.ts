...
describe('Test API', () => {
    ...
    function checkCodequest(codequest: CodeQuest) {
        ...
        expect(codequest.languages.map((langDoc: Language) => LanguageFactory.newLanguage(langDoc.name, langDoc.versions))).toEqual(languages);
    }
    ...
    describe('Test POST new codequest', () => {
        ...
        it('should return 201 and POST codequest', async () => {
        ...
        it('should return 400 and cannot POST codequest because author\'s name is empty', async () => {
        ...
        it('should return 400 and cannot POST codequest because title is empty', async () => {
            const invalidCodequest = {
                title: null,
                author: author,
                problem: problem,
        ...
        it('should return 400 and cannot POST codequest because problem is null', async () => {
            const invalidCodequest = {
                title: title,
                author: author,
                problem: null,
            ...
            expect(response.status).toBe(BAD_REQUEST)
            expect(response.body.success).toBe(false)
            expect(response.body.message).toBe('Invalid problem: problem\'s body cannot be empty')
        }, timeout)

        it('should return 400 and cannot POST codequest because problem\'s examples are empty', async () => {
        ...
        it('should return 400 and cannot POST codequest because languages name are null', async () => {
            const invalidCodequest = {
                title: title,
                author: author,
                problem: problem,
        ...
        it('should return 404 and cannot POST codequest because languages version is empty', async () => {
        ...
        it('should return 404 and cannot POST codequest because languages are available', async () => {
    ...
    describe('Test GET codequest', () => {
        ...
        it('should return 200 and GET all codequests', async () => {
            ...
            expect(response.body.codequests[1].languages.map((langDoc: Language) => LanguageFactory.newLanguage(langDoc.name, langDoc.versions))).toEqual(languages);
            checkCodequest(response.body.codequests[0])
        }, timeout)

        it('should return 200 and GET codequest by id', async () => {
            let addCodequest = await request
                .post('/codequests')
                .send(codeQuest)
                .set('Accept', 'application/json')
            const response = await request
        ...
        it('should return 200 and GET codequests by author', async () => {
            const response = await request
                .get('/codequests/authors/' +  author)
        ...
        it('should return 200 and GET codequests by language', async () => {
            const language = {
        ...
        it('should return 200 and an empty list if there are no codequests created by a user', async () => {
        ...
        it('should return 404 if the codequest id doesn\'t exist', async () => {
            const fakeId = new mongoose.Types.ObjectId()
            const response = await request
                .get('/codequests/' + fakeId)
        ...
        it('should return 404 if language is not available', async () => {
        ...
        it('should return 404 if language version is not available', async () => {
            const invalidLanguage = {
                name: "Java",
                versions: ["1"]
            }
    ...
    describe('Test PUT codequest', () => {
        ...
        it('should return 200 and update problem', async () => {
            const postResponse = await request
                .post('/codequests')
                .send(codeQuest)
                .set('Accept', 'application/json')
            const id = postResponse.body.codequest.id
            const newProblem = new Problem("New body", [new Example('new example1', 'new example2', 'new explanation')], ['new constraints'])
        ...
        it('should return 200 and update problem\'s title', async () => {
            const postResponse = await request
                .post('/codequests')
                .send(codeQuest)
                .set('Accept', 'application/json')
        ...
        it('should return 200 and update problem\'s languages', async () => {
            const postResponse = await request
                .post('/codequests')
                .send(codeQuest)
                .set('Accept', 'application/json')
        ...
        it('should return 404 if the codequest id is invalid', async () => {
            const fakeId = new mongoose.Types.ObjectId()
