...
* **deps:** update dependency mongoose to v8.17.0 ([#201](https://github.com/AlexTesta00/CodeMaster/issues/201)) ([c667ab3](https://github.com/AlexTesta00/CodeMaster/commit/c667ab37cfc3a93b628ce8bfccee097b54f58038))

## [3.5.2](https://github.com/AlexTesta00/CodeMaster/compare/v3.5.1...v3.5.2) (2025-07-25)

### Bug Fixes

* **deps:** update node.js dependencies ([#200](https://github.com/AlexTesta00/CodeMaster/issues/200)) ([598a236](https://github.com/AlexTesta00/CodeMaster/commit/598a23679745c9da4309c6b4691999ccc16b2be8))
...
* **deps:** update node.js dependencies ([#183](https://github.com/AlexTesta00/CodeMaster/issues/183)) ([980cac4](https://github.com/AlexTesta00/CodeMaster/commit/980cac4baafd628d805c22d42ed7bd20eca9da29))
...
* **docs:** add codequest, solution, community and code-generator service api documentation ([f1314a5](https://github.com/AlexTesta00/CodeMaster/commit/f1314a50a71674292b8f59dfed6f217b0f52918f))
* **frontend-service:** add clickable codequest in CodePage side bar ([00c6996](https://github.com/AlexTesta00/CodeMaster/commit/00c6996f1d02d0f79c307d29bdaf62bbe83861bc))

## [3.2.2](https://github.com/AlexTesta00/CodeMaster/compare/v3.2.1...v3.2.2) (2025-07-07)

### Bug Fixes

* **deps:** update node.js dependencies ([#173](https://github.com/AlexTesta00/CodeMaster/issues/173)) ([f1d8f03](https://github.com/AlexTesta00/CodeMaster/commit/f1d8f03b263e3ae079869bfab352c245ea6ede0e))

## [3.2.1](https://github.com/AlexTesta00/CodeMaster/compare/v3.2.0...v3.2.1) (2025-07-03)

### Bug Fixes

* **deps:** update node.js dependencies ([#170](https://github.com/AlexTesta00/CodeMaster/issues/170)) ([27a1ecb](https://github.com/AlexTesta00/CodeMaster/commit/27a1ecb73f7f8832443e2bf1ce461ccd65db1fb4))

## [3.2.0](https://github.com/AlexTesta00/CodeMaster/compare/v3.1.0...v3.2.0) (2025-07-03)

### Features

* **authentication:** added SweetAlert2 library for create toast and modal ([b20f9ce](https://github.com/AlexTesta00/CodeMaster/commit/b20f9ce47dd9204d59edd0b3e31a617b5abc8e7b))
* **authentication:** added SweetAlert2 library for create toast and modal ([485b552](https://github.com/AlexTesta00/CodeMaster/commit/485b552d2b2f1df910f259298ff1354f6077b227))
* **authentication:** added system to notify an user, using sweetalert library ([9af7eb0](https://github.com/AlexTesta00/CodeMaster/commit/9af7eb077315b0f25627d23f6dbcac92da241462))
* **authentication:** added system to notify an user, using sweetalert library ([2d79101](https://github.com/AlexTesta00/CodeMaster/commit/2d791018ee7d3ff8091452761d4b22cc19d6285a))
* **authentication:** store nickname after login ([35d3425](https://github.com/AlexTesta00/CodeMaster/commit/35d3425cfe342949bbc6f4479ba4e9d49f070460))
* **authentication:** store nickname after login ([9624709](https://github.com/AlexTesta00/CodeMaster/commit/9624709bdf3ad696ade5531d54f3ef77fca4405b))
* **frontend-service:** add buttons to add and remove examples in codequests ([7742990](https://github.com/AlexTesta00/CodeMaster/commit/7742990867c2c418df6a6ccef9e8da486534d1ff))
* **frontend-service:** add buttons to add and remove examples in codequests ([65f03f8](https://github.com/AlexTesta00/CodeMaster/commit/65f03f887d5d29becaa5a3f418d341d9f19ced37))
* **frontend-service:** add comment section to CodePage ([e2e6f22](https://github.com/AlexTesta00/CodeMaster/commit/e2e6f224f03608e1727f87a03040b4c14b124f92))
* **frontend-service:** add function examples page ([beba386](https://github.com/AlexTesta00/CodeMaster/commit/beba386841b643ba5ac42223ffa6e3a9da2c8d5f))
* **frontend-service:** add share and reset button in CodePage ([d342a52](https://github.com/AlexTesta00/CodeMaster/commit/d342a527a8cdffc9c868b497dec39e6183c346e4))
* **frontend-service:** add solutions creations and visualization ([38f2f95](https://github.com/AlexTesta00/CodeMaster/commit/38f2f958922cf7f2123339da320e2b3068b908bf))
* **frontend-service:** add solutions creations and visualization ([d17cf15](https://github.com/AlexTesta00/CodeMaster/commit/d17cf15b1a0908950e2b29c5985fc0844645b51b))
* **frontend-service:** add task to build multi lang runner and run docker compose ([42d8615](https://github.com/AlexTesta00/CodeMaster/commit/42d8615d1d514c3778716d3e3a1a40530bc244fe))
* **frontend-service:** add the possibility to create a new codequest ([0e173dd](https://github.com/AlexTesta00/CodeMaster/commit/0e173ddca41bb03668ba566ee3f19083f814fb99))
* **frontend-service:** add the possibility to create a new codequest ([6582c9c](https://github.com/AlexTesta00/CodeMaster/commit/6582c9c5e2d0f14f6c2322a4f3599bd37d42ff1d))
* **frontend-service:** now debug and execution of code show results ([0e57b2d](https://github.com/AlexTesta00/CodeMaster/commit/0e57b2d10fb38d001299650e895b32e6bbe9f475))
* **frontend-service:** now is possible to edit, debug and execute code ([843b3b7](https://github.com/AlexTesta00/CodeMaster/commit/843b3b7de524410294badaa18a95484b0f2cff6d))
* **frontend:** add chose characters page ([126dd5d](https://github.com/AlexTesta00/CodeMaster/commit/126dd5dd4369552f8852f101f83495c89e5c60ea))
* **frontend:** add chose characters page ([e913cc2](https://github.com/AlexTesta00/CodeMaster/commit/e913cc2f6c19b8c0b0c52aa2dc3dfda3bbd55c4e))
* **frontend:** add code page, this page can provide a code editor for solve codequests ([d08be22](https://github.com/AlexTesta00/CodeMaster/commit/d08be2246e52f3d195981402029f10bde2914fff))
* **frontend:** add code page, this page can provide a code editor for solve codequests ([70804b3](https://github.com/AlexTesta00/CodeMaster/commit/70804b34fba626e764efbe99b919f405c3e3a01b))
* **frontend:** add dashboard page ([b2a42c3](https://github.com/AlexTesta00/CodeMaster/commit/b2a42c323ab73058639b62b893f255786ee92158))
* **frontend:** add dashboard page ([f59c7f2](https://github.com/AlexTesta00/CodeMaster/commit/f59c7f2f79b614c541effba6cf968186320b5bd7))
* **frontend:** add easter egg ([8c9e4cd](https://github.com/AlexTesta00/CodeMaster/commit/8c9e4cd8d3d5da92e8eada93ee257d73b3f6d9d7))
* **frontend:** add easter egg ([120aaa6](https://github.com/AlexTesta00/CodeMaster/commit/120aaa66af1b9674ee702dc8361959a0b6884397))
* **frontend:** add error page ([930e0c0](https://github.com/AlexTesta00/CodeMaster/commit/930e0c0d06969216d9045e2cd7b80d34f8857b58))
* **frontend:** add error page ([8a4e523](https://github.com/AlexTesta00/CodeMaster/commit/8a4e52314ab6ad32e13a95d57230d3920fa6692e))
* **frontend:** add home page ([9183139](https://github.com/AlexTesta00/CodeMaster/commit/9183139abed61117c2e05f5b23e93e10653b165a))
* **frontend:** add home page ([10d7f52](https://github.com/AlexTesta00/CodeMaster/commit/10d7f522e9f778a7b3d0344f2cd9a0f2324411e4))
* **frontend:** add HomeProfilePage ([729b48f](https://github.com/AlexTesta00/CodeMaster/commit/729b48fc5426277835527713cda2bf08a537a523))
* **frontend:** add HomeProfilePage ([fd77a49](https://github.com/AlexTesta00/CodeMaster/commit/fd77a49440b13536b6e7bd80c016c2be288b79bf))
* **frontend:** add login and register page ([9ede188](https://github.com/AlexTesta00/CodeMaster/commit/9ede1889d6299ebb49c99df5cde22195bddfd2cf))
* **frontend:** add login and register page ([3353aab](https://github.com/AlexTesta00/CodeMaster/commit/3353aabeb5cffce72dd4c2b6048ef037cc6fed7c))
* **frontend:** add new codequest page to insert a new codequest by user ([cb9ec93](https://github.com/AlexTesta00/CodeMaster/commit/cb9ec930380928deb2b6482999d0b07961f20e53))
* **frontend:** add new codequest page to insert a new codequest by user ([39ff3c7](https://github.com/AlexTesta00/CodeMaster/commit/39ff3c78e96bfed68215079a3b5774918dd7d8d3))
* **frontend:** add notification ([6eb7198](https://github.com/AlexTesta00/CodeMaster/commit/6eb719848becb1fd16628993c3e1d7758829f81f))
* **frontend:** add notification ([5897008](https://github.com/AlexTesta00/CodeMaster/commit/589700856df04043465c1766c55b9772943af9f5))
* **frontend:** add possibility to enable and disable dark mode in home page ([f4a17a3](https://github.com/AlexTesta00/CodeMaster/commit/f4a17a35f6eef23500147d179718efdeea64387f))
* **frontend:** add possibility to enable and disable dark mode in home page ([48d216d](https://github.com/AlexTesta00/CodeMaster/commit/48d216d1d371cbb9cc9265235ad4a352c66649dc))
* **frontend:** add router-link and router-view to navigate into pages ([52476c5](https://github.com/AlexTesta00/CodeMaster/commit/52476c50f708562d5feae219388ad61466c3a7fd))
* **frontend:** add router-link and router-view to navigate into pages ([4bce76b](https://github.com/AlexTesta00/CodeMaster/commit/4bce76b806eb7935495edcde5660d3ec27739fb0))
* **frontend:** Add settings page ([a9fd6cb](https://github.com/AlexTesta00/CodeMaster/commit/a9fd6cbd3538ef1cc2f5db341a728b518c4248a8))
* **frontend:** Add settings page ([02656db](https://github.com/AlexTesta00/CodeMaster/commit/02656db1f1a248e1cd1611cfaa30ee19d6502d3a))
* **frontend:** added Admin Page, added possibility to ban and unban user, added banned user page ([82392eb](https://github.com/AlexTesta00/CodeMaster/commit/82392eb41cc658436b93d6e9121e24c3e6e655ba))
* **frontend:** added fp-ts library ([3ccbf90](https://github.com/AlexTesta00/CodeMaster/commit/3ccbf90367923a2adf7dc938fe62dbb81b684ddf))
* **frontend:** added fp-ts library ([69664dd](https://github.com/AlexTesta00/CodeMaster/commit/69664ddb4c3fedfc0f58450b33faaeddaf9ac628))
* **frontend:** added level image into dashboard page ([a901592](https://github.com/AlexTesta00/CodeMaster/commit/a9015924529c0e13ae90b3c2c0a2fa5819d71f81))
* **frontend:** added level image into dashboard page ([488a83b](https://github.com/AlexTesta00/CodeMaster/commit/488a83b5180ff22994021929a461c581f57a70bc))
* **frontend:** added Loading page ([a98ef01](https://github.com/AlexTesta00/CodeMaster/commit/a98ef01776ad4fa872aef30906851e5fa7178686))
* **frontend:** added Loading page ([e9fa5f7](https://github.com/AlexTesta00/CodeMaster/commit/e9fa5f79b2669bc9366607d8f9952c659c6ac463))
* **frontend:** added pinia to store variable and use session ([3eeab56](https://github.com/AlexTesta00/CodeMaster/commit/3eeab56894b4cb378ba500a2c9f0df618fe43eed))
* **frontend:** added pinia to store variable and use session ([07b8fcc](https://github.com/AlexTesta00/CodeMaster/commit/07b8fcc84f1ed048177c89675c90a64e7e218ea7))
* **frontend:** added possibility to chancge profile bio,cv and favorite languages ([b674d98](https://github.com/AlexTesta00/CodeMaster/commit/b674d980b34dc23a349f133306d84b2b5a5d7293))
* **frontend:** added possibility to chancge profile bio,cv and favorite languages ([d815148](https://github.com/AlexTesta00/CodeMaster/commit/d81514839fa6815ee840eafd3b9c530628c54f91))
* **frontend:** added possibility to enable or disable dark mode ([9aaca60](https://github.com/AlexTesta00/CodeMaster/commit/9aaca60286db87d768b37844f6fbf7f687e08524))
* **frontend:** added possibility to enable or disable dark mode ([dd45321](https://github.com/AlexTesta00/CodeMaster/commit/dd453215d841c776641359acf48bf9c08f6d11af))
* **frontend:** added possibility to Login/Register an user ([c6f2dd6](https://github.com/AlexTesta00/CodeMaster/commit/c6f2dd6f2aa0c1f9645cb77e207702997fbebc9f))
* **frontend:** added possibility to Login/Register an user ([c1bfbfc](https://github.com/AlexTesta00/CodeMaster/commit/c1bfbfc66b9a3c175400e95bab17758c0d0a54bb))
* **frontend:** added possibility to update user profile picture in user profile screen ([9beb7c0](https://github.com/AlexTesta00/CodeMaster/commit/9beb7c03c469870c14d4922e5c5c44a4e1c7346c))
* **frontend:** added possibility to update user profile picture in user profile screen ([447f303](https://github.com/AlexTesta00/CodeMaster/commit/447f30316a202cc7b7922a1de2f05bac1f663aab))
* **frontend:** added routes for admin page ([2efc4ad](https://github.com/AlexTesta00/CodeMaster/commit/2efc4ad12e9f40a9a87cb357de14289725e875f0))
* **frontend:** added sweetAlert modal with image ([6b3cf1d](https://github.com/AlexTesta00/CodeMaster/commit/6b3cf1deb859ba2c7de145107122eacd8d7f3b44))
* **frontend:** added sweetAlert modal with image ([2ff8e28](https://github.com/AlexTesta00/CodeMaster/commit/2ff8e2856ef287dd5a47343e5358b8d88414fc53))
* **frontend:** added the ability to assign a trophy to a user, now when the user registers they are assigned the welcome trophy ([e1de027](https://github.com/AlexTesta00/CodeMaster/commit/e1de027aa5e09c93443d9edb5c08e3cda7c41f36))
* **frontend:** added the ability to assign a trophy to a user, now when the user registers they are assigned the welcome trophy ([bc8b1ed](https://github.com/AlexTesta00/CodeMaster/commit/bc8b1ed6f7a83e884b1ed88ff2d704977a823eae))
* **frontend:** added user info into dasboard page ([a0e0125](https://github.com/AlexTesta00/CodeMaster/commit/a0e0125dcb706c6d1d6a5f9eef1ba88baade4d55))
* **frontend:** added user info into dasboard page ([d9f6123](https://github.com/AlexTesta00/CodeMaster/commit/d9f6123dfba856a291cc56d3754ff1b06947e107))
* **frontend:** dockerize frontend-service ([e89ab84](https://github.com/AlexTesta00/CodeMaster/commit/e89ab842a49f0cc1b9bdd587e3c9e7bcf3a4e218))
* **frontend:** dockerize frontend-service ([6936e6e](https://github.com/AlexTesta00/CodeMaster/commit/6936e6e69493da6ea26deea91ef24ef57a28a4b8))
* **frontend:** now in codepage, when user press home button appears dialog to confirmation ([913f1c3](https://github.com/AlexTesta00/CodeMaster/commit/913f1c3cec55cd02c39906da0924311b3d87aafe))
* **frontend:** now in codepage, when user press home button appears dialog to confirmation ([ae9a7b7](https://github.com/AlexTesta00/CodeMaster/commit/ae9a7b761dfdc459fe45f42239e7cbb364776203))
* **frontend:** now route /dashboard /profile /choiche /settings /code /codequest are protected by login ([102e3a9](https://github.com/AlexTesta00/CodeMaster/commit/102e3a9f23e09d9a3670facbda8ab68381a2dca1))
* **frontend:** now route /dashboard /profile /choiche /settings /code /codequest are protected by login ([4ce18ba](https://github.com/AlexTesta00/CodeMaster/commit/4ce18baa8e33303dead890f93a0a78c02611033c))
* **populate-db:** add generated code, comments and solutions for codequests ([bc85d75](https://github.com/AlexTesta00/CodeMaster/commit/bc85d758a52765d0512edfa30eb63d156bf862fc))

### Bug Fixes

* **api-gateway:** added routes for trophy and levels ([785aa70](https://github.com/AlexTesta00/CodeMaster/commit/785aa7080f0548554b4e26cfac3e2ad5d35e001e))
* **api-gateway:** added routes for trophy and levels ([c7f2128](https://github.com/AlexTesta00/CodeMaster/commit/c7f2128e5af14a45b5289a96648db88314e5643c))
* **api-gateway:** fix error for } parentheses ([3c24805](https://github.com/AlexTesta00/CodeMaster/commit/3c2480508c075f70a99bc20e93513bfea60eb219))
* **frontend:** change task name for prettier ([718b3ce](https://github.com/AlexTesta00/CodeMaster/commit/718b3ce42e2a2bf60acc133f29f633aeaad5895a))
* **frontend:** change task name for prettier ([310e697](https://github.com/AlexTesta00/CodeMaster/commit/310e697cb1ffbe9fccda81a38a652c358fbb5405))
* **frontend:** delete unwrap function, because is unusued ([034476c](https://github.com/AlexTesta00/CodeMaster/commit/034476c51c9329e9360f19dc68c9599a2404c47c))
* **frontend:** delete unwrap function, because is unusued ([8fd0f35](https://github.com/AlexTesta00/CodeMaster/commit/8fd0f35a764dfe92eb11c29e13ded61d90cbac2f))
* **frontend:** fix bug that did not allow the build ([8a00473](https://github.com/AlexTesta00/CodeMaster/commit/8a004736d277c2cf042c789b9c84c904499b54ac))
* **frontend:** fix bug that did not allow the build ([4430c6f](https://github.com/AlexTesta00/CodeMaster/commit/4430c6f12d9f8d692c6898899c56dbb7471222e6))
* **frontend:** fix compiler options ([dbe7e4f](https://github.com/AlexTesta00/CodeMaster/commit/dbe7e4fdcd8b96d4601553626459f53daaff2c58))
* **frontend:** fix compiler options ([c05249a](https://github.com/AlexTesta00/CodeMaster/commit/c05249aa4b8440d300193e466b4d5e5de48392d0))
* **frontend:** fix package-lock.json ([4e31f64](https://github.com/AlexTesta00/CodeMaster/commit/4e31f6404f4b6fa76aad2e050033c2118a8de705))
* **frontend:** fix package-lock.json ([119ac00](https://github.com/AlexTesta00/CodeMaster/commit/119ac00c58e5c6eb6b6091f3da24442b54dc7125))
* **frontend:** fix router.back() ([a25f970](https://github.com/AlexTesta00/CodeMaster/commit/a25f970a760a39fe4d29009d26ecc50c30f6e53d))
* **frontend:** fix router.back() ([09d7ed8](https://github.com/AlexTesta00/CodeMaster/commit/09d7ed8e0f10e2c0a73d69b756d240f6e1dcdffa))
* **frontend:** now the color of progress bar and the color of button difficulty have correct colors ([0d01565](https://github.com/AlexTesta00/CodeMaster/commit/0d01565595b37821193cfd1e59d4632211d90263))
* **frontend:** now the color of progress bar and the color of button difficulty have correct colors ([c6b12a2](https://github.com/AlexTesta00/CodeMaster/commit/c6b12a29a17b55d06fb1732bf89aaf199476298b))
* **frontend:** remove unusued variables ([f6489f4](https://github.com/AlexTesta00/CodeMaster/commit/f6489f4cc22ff3b27ee00088033297b9bd80fbd4))
* **frontend:** remove unusued variables ([c960779](https://github.com/AlexTesta00/CodeMaster/commit/c960779ff4de7e6069fa37d35cb42f968b4d0f9e))
* **frontend:** resolve merge conflict ([7f68e8d](https://github.com/AlexTesta00/CodeMaster/commit/7f68e8d0aa7c0cd4764335d56a15f4917f4eb9bc))
* **gradle:** added in dockerCompose tasks, --build option ([804a1f4](https://github.com/AlexTesta00/CodeMaster/commit/804a1f40bdac7867ad73f0d0369eca7fc5b365a6))
* **solution-service:** fix kotlin and scala template files ([e572e86](https://github.com/AlexTesta00/CodeMaster/commit/e572e8623396c48f39e22b15e07262f7d82d5c27))
...
* **deps:** update node.js dependencies ([#156](https://github.com/AlexTesta00/CodeMaster/issues/156)) ([8b2aabf](https://github.com/AlexTesta00/CodeMaster/commit/8b2aabf517f13e925d9f0847b27aab6e1a8ff4e9))

## [3.0.1](https://github.com/AlexTesta00/CodeMaster/compare/v3.0.0...v3.0.1) (2025-06-27)

### Bug Fixes

* **deps:** update node.js dependencies ([#154](https://github.com/AlexTesta00/CodeMaster/issues/154)) ([9cb3551](https://github.com/AlexTesta00/CodeMaster/commit/9cb35510ab6145e01c1a4b84054042686d6123ae))
