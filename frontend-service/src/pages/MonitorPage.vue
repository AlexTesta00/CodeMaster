...
<template>
    ...
    >
        <div
            class="bg-background dark:bg-bgdark w-full h-full flex flex-col items-center justify-center lg:items-start lg:justify-center my-6"
        >
            <h1 class="text-4xl w-full text-center">
            ...
            <service-card
                ...
                :status="codeQuestServiceStatus"
            ></service-card>
            <service-card
                name="Solution Service"
                :status="solutionServiceStatus"
            ></service-card>
            <service-card
            ...
            <service-card
                ...
                :status="codeGenerationServiceStatus"
            ></service-card>
        </div>
    </section>
</template>
